...
function createBalloon() {
    ...
    div.style.left = rand + 'px'; // to apply the movement of random balloons
...
function animateBalloon(elem) {
    ...
    function frame() {
        if (pos >= (windowHeight + 200 ) && (document.querySelector('[data-number="'+elem.dataset.number+'"]') !==null)) { //to hide balloon after it reaches the edge of the browser's screen vertically
